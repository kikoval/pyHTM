...
class ExhaustiveSweep(BaseExplorer):
    ...
    def _firstSweepPosition(self):
        """Go to the first sweep position for the current image and sweep
        direction.
        """
    ...
    def _nextSweepPosition(self):
        ...
        Returns:
            True (nextImage) if we exhausted all sweeps.
        """
    ...
    def _getNumIterationsForImage(self, image):
        """Return the number of iterations for the image, given the current
        parameters.
        """
